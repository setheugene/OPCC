...
require_once( plugin_dir_path( __FILE__ ) . 'custom-gravity-forms.php' );
require_once( plugin_dir_path( __FILE__ ) . 'custom-components-list.php' );
require_once( plugin_dir_path( __FILE__ ) . 'custom-parser.php' );
require_once( plugin_dir_path( __FILE__ ) . 'custom-modern-custom-events.php' );
