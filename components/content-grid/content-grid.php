...
$background_color = isset( $component_data['background_color']['background_color'] ) ? $component_data['background_color']['background_color'] : 'bg-brand-white';
...
if ( ll_isset( $component_data['full_screen_height'] ) ) {
  ...
  $top_mp_amount = 'pt-24';
  $bottom_mp_amount = 'pb-24';
} else {
  $full_screen = '';
  $top_mp_amount = 'pt-' . $component_data['top_spacing'];
  $bottom_mp_amount = 'pb-' . $component_data['bottom_spacing'];
}
...
<section class="content-grid relative z-10 <?php echo $full_screen; ?> <?php echo $background_color; ?> <?php echo $overlay; ?> <?php echo $top_mp_amount; ?> <?php echo $bottom_mp_amount; ?> <?php echo implode( " ", $classes ); ?>" <?php echo ( $component_id ? 'id="'.$component_id.'"' : '' ) ?> data-component="content-grid">
  <?php
    if ( $component_data['background_type'] == 'background-image' ) {
  ...
  <div class="container relative z-10">
    <div class="justify-center row">
      <div class="col w-full <?php echo $component_data['narrow'] == true && $component_data['columns'] !== '1' ? 'xl:w-10/12' : ''; ?>">
        <div class="row -mb-8 <?php echo $component_data['columns'] == '1' ? 'justify-center' : ''; ?>">
