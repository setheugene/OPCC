...
$background_color = isset( $component_data['background_color'] ) ? $component_data['background_color'] : 'bg-brand-white';

/* set margin or padding */
$mp = 'my';
if ( $background_color !== 'bg-brand-white' ) {
  $mp = 'py';
}
...
<section class="image-grid overflow-hidden relative <?php echo $background_color; ?> <?php echo $mp_amount; ?> <?php echo implode( " ", $classes ); ?>" <?php echo ( $component_id ? 'id="'.$component_id.'"' : '' ); ?> data-component="image-grid">
