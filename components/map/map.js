        ...
        mapLocations.forEach( ( loc, index ) => {
          const place = {
            ...
            properties: {
              ...
              <a class="block p-2 leading-normal text-center text-brand-white bg-brand-black rounded-br rounded-bl" href="https://www.google.com/maps/place/${loc.address.street}+${loc.address.city}+${loc.address.state}" target="_blank">Get Directions</a>`,
            },
            geometry: {
              type: 'Point',
